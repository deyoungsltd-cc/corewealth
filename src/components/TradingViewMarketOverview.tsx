    ...
    el.innerHTML = JSON.stringify({
      ...
      tabs: [
        ...
        },
        {
          title: 'Tech',
          symbols: [
            { s: 'FOREXCOM:EURUSD', d: 'CoreWealth' },
      ...
      {timedOut && !loaded && (
        <div className="absolute inset-0 flex items-center justify-center bg-[#1a1a1a]">
          <div className="flex flex-col items-center gap-3">
            ...
            <button onClick={() => { setTimedOut(false); setLoaded(false); loadWidget(); }} className="text-[#7C3AED] text-[10px] font-medium hover:underline">Retry</button>
          </div>
        </div>
      )}
    </div>
