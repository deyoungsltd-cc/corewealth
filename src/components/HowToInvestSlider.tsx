    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div
              className="relative bg-gradient-to-br from-[#0d0d0d] via-[#1a0505] to-[#0d0d0d] border border-border rounded-3xl p-8 sm:p-10 overflow-hidden"
              style={{
            ...
            >
              ...
              {activeStep === STEPS.length - 1 && (
                <div className="relative mt-6 flex justify-center">
                  <Link
                    href="/investments"
                    className="inline-flex items-center gap-2 bg-[#7C3AED] hover:bg-[#6D28D9] text-white text-xs font-semibold px-6 py-2.5 rounded-lg transition-colors"
                  >
                    Start Investing Now
        ...
        <div
          className="absolute top-1/2 -translate-y-1/2 -left-4 sm:left-8 w-20 h-32 sm:w-28 sm:h-44 bg-card border border-border rounded-2xl opacity-30 hidden sm:block"
          style={{
        ...
        >
          <div className="p-3 h-full flex flex-col justify-between">
            <div className="w-6 h-6 rounded-md bg-border" />
        ...
        <div
          className="absolute top-1/2 -translate-y-1/2 -right-4 sm:right-8 w-20 h-32 sm:w-28 sm:h-44 bg-card border border-border rounded-2xl opacity-30 hidden sm:block"
          style={{
            transform: 'rotateY(-35deg) translateZ(-50px)',
            boxShadow: '0 10px 30px -10px rgba(0,0,0,0.5)',
          }}
      ...
      <div className="flex items-center justify-center gap-4 mt-2">
        <button
          ...
          className="w-10 h-10 rounded-full bg-card border border-border hover:border-[#7C3AED]/50 text-gray-400 hover:text-white flex items-center justify-center transition-colors disabled:opacity-40"
