      ...
      return (
        <div className="relative w-28 h-28 mx-auto">
          ...
          <div
            ...
            style={{
              background: 'radial-gradient(circle, #7C3AED 0%, rgba(204,0,0,0.3) 70%, transparent 100%)',
              animation: 'hti-pulse-scale 2s ease-in-out infinite',
            }}
          />
          {/* Cross lines */}
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <div className="absolute w-8 h-px bg-gradient-to-r from-transparent via-corewealth-gray-600 to-transparent" />
            <div className="absolute h-8 w-px bg-gradient-to-b from-transparent via-corewealth-gray-600 to-transparent" />
          </div>
        </div>
      );
        ...
        <div className="relative w-28 h-28 mx-auto">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-5 h-3 relative">
              <div
                className="absolute left-0 top-[6px] w-[6px] h-[10px] border-r-2 border-b-2 border-[#7C3AED] rotate-45"
    ...
    case 'coin-stack':
      return (
        <div className="relative w-28 h-28 mx-auto">
          ...
          <div
            className="absolute left-1/2 -translate-x-1/2 text-[#7C3AED] font-bold text-sm"
            style={{
              top: '22px',
          ...
          <div className="absolute left-1/2 -translate-x-1/2 bottom-2 flex flex-col items-center">
            <div
              className="w-px h-5"
              style={{
                background: 'linear-gradient(to top, transparent, #7C3AED)',
    ...
    >
      ...
      <div className="perspective-container relative w-full overflow-hidden" style={{ height: '440px' }}>
        ...
        {SLIDES.map((slide, i) => {
          ...
          return (
            ...
            >
              <div
                className="relative w-full max-w-md mx-4 bg-card border border-border rounded-3xl p-8 sm:p-10 overflow-hidden"
                style={{
                  boxShadow:
              ...
              >
                ...
                <div
                  ...
                  style={{ color: '#7C3AED', fontFamily: 'Arial, Helvetica, sans-serif' }}
                >
                ...
                {/* Divider */}
                <div className="relative mx-auto w-12 h-px mb-4" style={{ background: 'linear-gradient(90deg, transparent, #7C3AED, transparent)' }} />

                {/* Description */}
                <p className="relative text-center text-corewealth-gray-300 text-sm sm:text-base leading-relaxed max-w-xs mx-auto">
                  {slide.description}
                </p>

                {/* Step counter */}
                <div className="relative mt-6 flex items-center justify-center gap-2">
                  <span className="text-corewealth-gray-500 text-xs font-medium tracking-widest uppercase">
      ...
      <div className="flex items-center justify-center gap-3 mt-4">
        {SLIDES.map((s, i) => (
          <button
            ...
            className="transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#7C3AED] rounded-full"
          ...
          >
            <div
              ...
              style={{
                ...
                height: '8px',
                borderRadius: '9999px',
                backgroundColor: i === active ? '#7C3AED' : '#444',
      ...
      <div className="flex items-center justify-center gap-4 mt-3">
        <button
          onClick={goPrev}
          disabled={isTransitioning}
          className="w-10 h-10 rounded-full bg-card border border-border hover:border-[#7C3AED]/50 text-gray-400 hover:text-white flex items-center justify-center transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed focus:outline-none focus-visible:ring-2 focus-visible:ring-[#7C3AED]"
