    ...
    <div className="bg-card border border-border rounded-2xl overflow-hidden">
      ...
      <div className="p-8 text-center">
        ...
        <p className="text-gray-500 text-xs mt-1 max-w-xs mx-auto">
          ...
          Pick a plan on the <span className="text-corewealth-red">Investments</span> page to begin.
        </p>
        <a
          href="/investments"
          className="inline-block mt-4 px-4 py-2 rounded-md bg-corewealth-red text-white text-xs font-semibold hover:bg-red-700 transition-colors"
        >
          Browse Plans
        </a>
      </div>
      ...
      <div className="px-4 py-3 border-b border-border flex items-center justify-between flex-wrap gap-2">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="text-[10px] font-semibold px-2 py-1 rounded-md border border-border text-gray-400 hover:text-white hover:border-gray-500 transition-colors"
