...
export default function InvestmentCorrelationChart({
  ...
  return (
    <div
      className={`bg-card border border-border rounded-2xl overflow-hidden animate-fade-in ${className ?? ''}`}
    >
      {/* Header */}
      <div className="px-4 sm:px-5 pt-4 pb-0">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
          <div>
            ...
            <p className="text-[11px] text-corewealth-gray-400 mt-0.5">
              Portfolio performance vs. market benchmarks
            </p>
          </div>

          <div className="flex items-center gap-1 bg-corewealth-input rounded-lg p-0.5">
            {PERIODS.map((p) => (
              <button
                key={p}
                ...
                className={`px-3 py-1 text-[11px] font-semibold rounded-md transition-all duration-200 ${
                  activePeriod === p
                    ...
                    : 'text-corewealth-gray-400 hover:text-corewealth-gray-300'
                }`}
              >
                {p}
              </button>
        ...
        {/* Legend with returns */}
        <div className="flex flex-wrap items-center gap-x-5 gap-y-2 pb-3 border-b border-border/50">
          {series.map((s, i) => {
            ...
            return (
              <div key={s.label} className="flex items-center gap-2">
                ...
                />
                <span className="text-[11px] text-corewealth-gray-300 font-medium">
                  {s.label}
                </span>
                <span
      ...
      <div className="px-4 sm:px-5 pb-3">
        <p className="text-[10px] text-corewealth-gray-500">
