...
const boardMembers = [
  { name: 'CEO Musk', role: 'Chief Executive Officer', avatar: 'E' },
...
// ─── CoreWealth Logo Component ──────────────────────────────────────────────────────

function CoreWealthLogo({ size = 'default' }: { size?: 'small' | 'default' | 'large' }) {
...
export default function Landing({ onLogin, onRegister, onShowPlans }: LandingProps) {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {investmentCategories.map((cat, i) => {
              ...
              return (
                <div
                  key={cat.title}
                  className={`group card rounded-2xl p-6 cursor-pointer transition-all duration-700 ${
      ...
      {/* Divider */}
      <div className="corewealth-divider mx-auto max-w-6xl" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {(plans.length > 0 ? plans : defaultPlans).map((plan, i) => {
                ...
                return (
                  <div
                    key={plan.id}
                    className={`group card rounded-2xl p-6 relative overflow-hidden transition-all duration-700 ${
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className={`transition-all duration-700 delay-100 ${isVisible('about') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              <p className="text-neutral-400 leading-relaxed mb-6">
                CoreWealthPrimeCapital is a leading financial services company and pioneer in the online investment management industry. Having facilitated the first-ever electronic managed investment by an individual investor more than 10 years ago, we have grown to become one of the most trusted names in digital finance.
              </p>
            ...
            <div className={`transition-all duration-700 delay-200 ${isVisible('about') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              <div className="space-y-4">
                {boardMembers.map((member) => (
                  <div key={member.name} className="card rounded-xl p-4 flex items-center gap-4">
      ...
      <section id="features" ref={(el) => { sectionRefs.current.features = el; }} className="relative py-20 sm:py-28 px-4 sm:px-6">
        <div className="mx-auto max-w-6xl">
          <div className={`text-center mb-14 transition-all duration-700 ${isVisible('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <p className="mx-auto max-w-2xl text-neutral-400">
              Your investment broker holds your funds. It is important you verify it is safe. CoreWealthPrimeCapital is fully registered, regulated, and compliant with international financial standards. Your funds are always secure.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {coreFeatures.map((feature, i) => {
              ...
              return (
                <div
                  key={feature.title}
                  className={`group card rounded-2xl p-6 transition-all duration-700 ${
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <h2 className="text-3xl sm:text-4xl font-bold tracking-tight mb-4" style={{ fontFamily: 'var(--font-dm-sans), sans-serif' }}>
                  CoreWealthPrimeCapital gives you the best financial solution
                </h2>
                <p className="text-neutral-400 leading-relaxed mb-8">
      ...
      <section className="relative py-20 sm:py-28 px-4 sm:px-6">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto max-w-2xl text-neutral-400 leading-relaxed mb-8">
            Your security is our top priority. CoreWealthPrimeCapital employs industry-leading security measures to ensure your investments and personal data are protected at all times.
          </p>
      ...
      <section className="relative py-20 sm:py-28 px-4 sm:px-6">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              { name: 'Michael R.', location: 'New York, USA', text: 'CoreWealthPrimeCapital has completely transformed my investment strategy. The daily returns are consistent and the platform is incredibly easy to use.', rating: 5 },
      ...
      <footer className="border-t border-white/[0.04] px-4 sm:px-6">
        <div className="mx-auto max-w-6xl py-12">
          ...
          <div className="corewealth-divider mb-8" />

          {/* Bottom Bar */}
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-xs text-neutral-600">
              &copy; {new Date().getFullYear()} CoreWealthPrimeCapital. All rights reserved.
            </p>
