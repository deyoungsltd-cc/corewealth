        ...
        {investmentsLoading ? (
          ...
          <div className="space-y-3 max-h-96 overflow-y-auto pr-1 custom-scrollbar">
            {activeInvestments.map((inv) => {
              ...
              return (
                <div key={inv.id} className="bg-[#1a1a1a] rounded-lg p-4 border border-border">
                  {/* Header Row */}
            ...
            <div className="p-5">
              ...
              {numAmount > 0 && numAmount >= selectedPlan.min && numAmount <= selectedPlan.max && (
                <div className="mt-3 bg-[#1a1a1a] rounded-lg p-3 space-y-1.5 text-sm">
                  ...
                  <div className="border-t border-border pt-1.5 flex justify-between"><span className="text-gray-300 font-medium">Total Return</span><span className="text-green-400 font-bold">+${totalReturn.toFixed(2)}</span></div>
                </div>
              )}
              {numAmount > 0 && (numAmount < selectedPlan.min || numAmount > selectedPlan.max) && (
