          ...
          {totalPages > 1 && (
            <div className="flex items-center justify-between pt-2">
              <button
                ...
                disabled={page <= 1}
                className="px-4 py-2 rounded-lg text-sm font-semibold border border-border text-gray-400 hover:text-white hover:border-gray-500 transition-colors disabled:opacity-30 disabled:cursor-not-allowed disabled:hover:text-gray-400 disabled:hover:border-border"
              >
                Previous
              </button>
