  ...
  return (
    <div className="space-y-5">
      <div className="flex gap-3 flex-wrap">
        ...
        <div className="bg-card border border-border rounded-xl p-4 flex-1 min-w-[140px]"><p className="text-gray-500 text-xs">Transactions</p><p className="text-[#A78BFA] font-bold text-lg mt-1">{filtered.length}</p></div>
      </div>
