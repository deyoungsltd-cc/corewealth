...
const summaryCards = [
  { label: 'Opening Balance', value: '$275,120.00' },
  { label: 'Total Transactions', value: '$18,432.50' },
  { label: 'Closing Balance', value: '$280,645.00' },
]

const transactions = [
  { description: 'Salary', amount: '+$5,200.00', date: 'Aug 1', type: 'credit' as const },
  { description: 'Card Payment', amount: '-$249.99', date: 'Jul 31', type: 'debit' as const },
  { description: 'Transfer In', amount: '+$3,500.00', date: 'Jul 30', type: 'credit' as const },
  { description: 'Wire Transfer', amount: '-$1,200.00', date: 'Jul 28', type: 'debit' as const },
  { description: 'Netflix', amount: '-$15.99', date: 'Jul 27', type: 'debit' as const },
  { description: 'Deposit', amount: '+$12,000.00', date: 'Jul 25', type: 'credit' as const },
]
  ...
  return (
    <main className="min-h-screen bg-[#0F0F1A] px-4 py-6 md:px-8 lg:px-16">
      ...
      <header className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-[#F1F5F9] font-bold text-xl md:text-2xl">Checking Statement</h1>
          <p className="text-[#6B7280] text-sm mt-0.5">Checking Account ****7890</p>
        </div>
      </header>
