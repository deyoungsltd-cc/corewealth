      ...
      <div className="bg-card border border-border rounded-xl p-5 space-y-4">
        ...
        {!reviewing ? (
          <>
            ...
            <div className="bg-[#111] border border-border rounded-lg p-3"><div className="flex justify-between text-sm"><span className="text-gray-500">Wire transfer fee</span><span className="text-white">${fee.toFixed(2)}</span></div><div className="flex justify-between text-sm mt-1 font-bold"><span className="text-white">Total debit</span><span className="text-[#7C3AED]">${(amt + fee).toFixed(2)}</span></div></div>
            <button onClick={handleSubmit} className="w-full bg-[#7C3AED] hover:bg-[#6D28D9] text-white font-semibold py-3 rounded-lg transition-colors text-sm">Review & Confirm</button>
          </>
        ) : (
          <>
            <div className="bg-[#111] border border-[#7C3AED]/30 rounded-xl p-4 space-y-3">
