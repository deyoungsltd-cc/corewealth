...
const faqs = [
  {
    ...
    items: [
      { q: 'What is CoreWealth Bank?', a: 'CoreWealth Bank is a professionally managed investment platform that offers daily returns through diversified strategies including savings accounts, certificates of deposit, and investment portfolios, and sustainable energy investments. Our fund managers have decades of combined experience in financial markets, and our platform has been designed to make institutional-grade investment accessible to everyone, regardless of portfolio size. We operate with full transparency, real-time tracking, and regulatory compliance across all jurisdictions we serve.' },
      ...
      { q: 'Is CoreWealth Bank available in my country?', a: 'CoreWealth Bank serves investors in over 180 countries worldwide. Our platform is fully accessible via web browser on any device, including desktop, tablet, and mobile. We support multiple currencies and deposit methods including bank transfer, wire transfer, and check. If you can access our website and create an account, you can start investing regardless of your geographic location.' },
    ],
  },
  {
    category: 'Investment & Returns',
    items: [
      { q: 'How does CoreWealth Bank generate returns?', a: 'Our returns are generated through a diversified portfolio managed by experienced fund managers. The strategies include diversified asset management, interest-bearing accounts, and professional portfolio strategies. By spreading risk across these diverse channels, we maintain consistent daily returns while minimizing exposure to any single market downturn.' },
  ...
  },
  {
    ...
    items: [
      { q: 'What deposit methods are accepted?', a: 'We currently accept the following deposit methods: Bank Transfer, Wire Transfer, ACH, and Check. Bank transfers and ACH deposits are processed within 1-3 business days. Wire transfers and check deposits are verified and credited within 1-3 business hours. We are continuously evaluating additional payment methods to expand options for our investors.' },
      { q: 'How do I withdraw my earnings?', a: 'Withdrawing is simple and fast. Navigate to the Withdraw section in your dashboard, enter the amount you wish to withdraw (up to your available balance), and provide your bank account details or preferred payment method. For verified accounts, withdrawals are processed within minutes to a few hours. Larger withdrawals may require additional security verification for your protection. There are no hidden fees on withdrawals for Gold and Platinum plan investors.' },
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'What happens if the platform is hacked?', a: 'We maintain multiple layers of security including FDIC insurance covering up to $250,000 per depositor, with additional coverage through our partner institutions, multi-factor verification requirements, and real-time intrusion detection systems. In the unlikely event of a security breach, our reserve fund and insurance coverage would protect investor assets. We also maintain transparent communication with all investors regarding any security matters through our notification system.' },
    ],
  },
  {
...
export default function FAQPage() {
  ...
  return (
    <div className="page-enter relative overflow-hidden">
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className={`overflow-hidden transition-all duration-500 ease-in-out ${isOpen ? 'max-h-[500px] opacity-100' : 'max-h-0 opacity-0'}`}>
                          <div className="px-5 sm:px-6 pb-5 sm:pb-6 text-gray-400 text-sm leading-relaxed border-t border-border pt-5">{item.a}</div>
                        </div>
                      </div>
                    );
                  })}
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto relative z-10">
        <FadeIn delay={400}>
          <div className="text-center dash-card card-shine noise-overlay bg-card border border-border rounded-2xl p-10 animated-border">
