...
const sections = [
  { title: '1. Acceptance of Terms', content: ['By accessing or using the CoreWealth Bank platform, you agree to be bound by these Terms of Service, our Privacy Policy, and all applicable laws and regulations. If you do not agree with any part of these terms, you must not use our platform. These terms apply to all users, including investors, visitors, and any other persons who access or use the service.'] },
  { title: '2. Eligibility', content: ['To use CoreWealth Bank, you must be at least 18 years of age (or the legal age of majority in your jurisdiction). You must have the legal capacity to enter into binding agreements. By creating an account, you represent and warrant that you meet these eligibility requirements.'] },
  { title: '3. Account Registration and Security', content: ['You are responsible for maintaining the confidentiality of your account credentials, including your email address, password, and any two-factor authentication codes. You must notify us immediately if you suspect unauthorized access to your account. CoreWealth Bank will never ask for your password via email, phone, or any other communication channel.'] },
  { title: '4. Investment Services', content: ['CoreWealth Bank provides investment management services through professionally managed plans. All investments involve risk, and past performance does not guarantee future results. The daily return rates advertised are targets based on historical performance and market conditions, and actual returns may vary. We reserve the right to modify plan parameters with reasonable notice.'] },
  { title: '5. Deposits and Withdrawals', content: ['Deposits made via bank transfer are confirmed within 1-3 business days. Check and wire transfers are credited after verification, typically within 1-3 hours. Withdrawals are processed according to the timeline specified for your investment plan tier.'] },
