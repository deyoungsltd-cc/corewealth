  ...
  return (
    <div className="page-enter relative overflow-hidden">
      ...
      <section className="pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto relative z-10">
        <FadeIn delay={100}>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#7C3AED" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>, title: 'Email Support', detail: 'corewealthprimesupportt@gmail.com', sub: 'Response within 2 hours' },
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto relative z-10">
        <FadeIn delay={200}>
          <div className="dash-card card-shine noise-overlay bg-card border border-border rounded-2xl p-8 sm:p-10">
