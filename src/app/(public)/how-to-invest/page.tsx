    ...
    <div className="page-enter relative overflow-hidden">
      ...
      <section className="pt-28 pb-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto relative z-10">
        <FadeIn>
          <div className="text-center">
            ...
            <p className="text-gray-400 text-lg max-w-xl mx-auto leading-relaxed">A complete guide to getting started with CoreWealth Bank and maximizing your investment returns.</p>
          </div>
        </FadeIn>
      </section>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto relative z-10">
        <div className="relative">
          {/* Timeline line */}
          <div className="absolute left-[23px] sm:left-[27px] top-0 bottom-0 w-px bg-gradient-to-b from-[#7C3AED]/50 via-[#7C3AED]/20 to-transparent" />

          <div className="space-y-14">
            {steps.map((item, idx) => (
              <FadeIn key={item.step} delay={idx * 100}>
                <div className="relative dash-card card-shine noise-overlay bg-card border border-border rounded-2xl p-7 sm:p-9 hover:border-[#7C3AED]/20 transition-all duration-500">
                  <div className="flex items-start gap-5 sm:gap-7">
                    <div className="relative shrink-0 z-10 w-12 h-12 bg-[#7C3AED] rounded-xl flex items-center justify-center text-white font-bold text-lg pulse-ring shadow-[0_0_20px_rgba(204,0,0,0.3)]">
                      {item.step}
                    </div>
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="bg-[#1a1a1a] border border-border rounded-xl p-5">
                        <p className="text-[#7C3AED] text-xs font-bold uppercase tracking-wider mb-3">Pro Tips</p>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto relative z-10">
        <FadeIn delay={500}>
          <div className="dash-card card-shine noise-overlay bg-gradient-to-br from-[#7C3AED]/10 via-card to-card border border-[#7C3AED]/20 rounded-2xl p-10 animated-border">
