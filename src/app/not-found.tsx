  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', background: '#0a0a0f', color: '#fff', padding: '2rem' }}>
      <div style={{ textAlign: 'center', maxWidth: '480px' }}>
        <div style={{ fontSize: '5rem', fontWeight: 'bold', color: '#7C3AED', lineHeight: 1 }}>404</div>
        ...
        <a href="/" style={{ display: 'inline-block', background: '#7C3AED', color: '#fff', padding: '0.625rem 1.5rem', borderRadius: '0.5rem', textDecoration: 'none', fontSize: '0.875rem', fontWeight: 600 }}>
          Go to Homepage
        </a>
      </div>
    </div>
