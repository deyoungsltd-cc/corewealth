 ...
 * teslaprimesupportt@gmail.com Gmail account.
 *
 ...
 *          → Add yourself as a Test User (teslaprimesupportt@gmail.com)
 ...
 *   3. Log in as teslaprimesupportt@gmail.com (you'll see a "Google hasn't
...
console.log('\n═══════════════════════════════════════════════════════════════');
console.log('  Gmail OAuth — Refresh Token Generator for Tesla Prime');
console.log('═══════════════════════════════════════════════════════════════\n');
console.log('STEP 1: Open this URL in your browser:\n');
console.log(authUrl.toString());
console.log('\nSTEP 2: Sign in as teslaprimesupportt@gmail.com');
...
const server = http.createServer(async (req, res) => {
  ...
  try {
    ...
    console.log('SMTP_EMAIL=teslaprimesupportt@gmail.com  (used as From address)');
    console.log('EMAIL_FROM_NAME=Tesla Prime Capital');
    console.log('\n═══════════════════════════════════════════════════════════════');
